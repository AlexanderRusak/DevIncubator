...
void moveAI(char*  array[][4],int line);
bool isWin(char*  array[][4]);
bool isMatchHorizontal(char*  array[][4], bool modeAI);
...
bool isWin(char* array[][4])
{
	...
	if (isMatchHorizontal(array,false) || isMatchVertical(array) || isMatchDiagonal(array))
		return true;
	return false;
}
bool isMatchHorizontal(char*  array[][4], bool modeAI)
